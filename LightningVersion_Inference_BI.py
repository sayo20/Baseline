...
#         print(output[:,-1,:].shape)
    ...
    def test_step(self,batch,batch_idx):
        ...
        torch.save(df_test_dict,"Bi_experiments_2-results/bi-GU-LPS-V2-Ex2-TEST-"+str(batch_idx)+".pt")
...
if __name__ == '__main__':
    wandb_logger = WandbLogger(project="Exploring-Baseline-Experiment2", config='config_BI.yaml',name="bi-GU-LPS-V2-Ex2-TEST")#Bilateral_gu_LpsMasks
