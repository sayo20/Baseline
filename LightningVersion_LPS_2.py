...
if __name__ == '__main__':
    ...
    wandb_logger = WandbLogger(project="Exploring-Baseline-Experiment3", config='config_LPS-2.yaml',name="spectra-LPS-V2-Ex3")#Bilateral_gu_LpsMasks
    ...
    checkpoint_callback = ModelCheckpoint(
        ...
        save_top_k =-1,
        filename="spectra-LPS-V2-Ex3-{epoch:02d}-{val_loss:.2f}",#-{epoch:02d}-{val_loss:.2f}
        mode="min",)
    ...
    trainer.save_checkpoint("Spectral_experiments/spectra-Ex3.ckpt")
    script = model.to_torchscript()
    torch.jit.save(script, "Spectral_experiments/spectra-Ex3.pt")
