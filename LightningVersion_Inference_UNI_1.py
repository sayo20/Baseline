...
from torchmetrics.functional.audio import scale_invariant_signal_distortion_ratio,signal_distortion_ratio,scale_invariant_signal_noise_rati,signal_noise_ratio
...
#         print(output[:,-1,:].shape)
    ...
    def test_step(self,batch,batch_idx):
        ...
        torch.save(df_test_dict,"Uni_experiments_1-results/uni-GU-LPS-V2-Ex1-TEST-"+str(batch_idx)+".pt")
...
if __name__ == '__main__':
    wandb_logger = WandbLogger(project="Exploring-Baseline-Experiment1", config='config_UNI_1.yaml',name="uni-GU-LPS-V2-Ex1-TEST")#withouth window length
    ...
    trainer = Trainer(max_epochs=epoch,fast_dev_run=False,gpus=[1],logger=wandb_logger,auto_lr_find=True, profiler="simple") # max_epochs=epoch ,profiler="advanced", runs one batch to test that the model works
