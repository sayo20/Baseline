...
#         print(output[:,-1,:].shape)
    ...
    def test_step(self,batch,batch_idx):
        ...
        torch.save(df_test_dict,"Uni_experiments_3-results/uni-GU-LPS-V2-Ex3-TEST-"+str(batch_idx)+".pt")
...
if __name__ == '__main__':
    wandb_logger = WandbLogger(project="Exploring-Baseline-Experiment3", config='config_UNI_3.yaml',name="uni-GU-LPS-V2-Ex3-TEST")#withouth window length
    ...
    trainer = Trainer(max_epochs=epoch,fast_dev_run=False,gpus=[2],logger=wandb_logger,auto_lr_find=True, profiler="simple") # max_epochs=epoch ,profiler="advanced", runs one batch to test that the model works
