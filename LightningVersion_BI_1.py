...
if __name__ == '__main__':
    ...
    wandb_logger = WandbLogger(project="Exploring-Baseline-Experiment1", config='config_BI_1.yaml',name="bi-GU-LPS-V2-Ex1")#Bilateral_gu_LpsMasks
    ...
    checkpoint_callback = ModelCheckpoint(
        ...
        save_top_k =-1,
        filename="bi-GU-LPS-V2-Ex1-{epoch:02d}-{val_loss:.2f}",#-{epoch:02d}-{val_loss:.2f}
        mode="min",)
    ...
    trainer.save_checkpoint("Bi_experiments/bi-GU-LPS-V2-Ex1.ckpt")
    script = model.to_torchscript()
    torch.jit.save(script, "Bi_experiments/bi-GU-LPS-V2-Ex1.pt")
