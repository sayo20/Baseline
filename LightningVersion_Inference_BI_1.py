...
#         print(output[:,-1,:].shape)
    ...
    def test_step(self,batch,batch_idx):
        ...
        torch.save(df_test_dict,"Bi_experiments_1-results/bi-GU-LPS-V2-Ex1-TEST-"+str(batch_idx)+".pt")
...
if __name__ == '__main__':
    wandb_logger = WandbLogger(project="Exploring-Baseline-Experiment1", config='config_BI_1.yaml',name="bi-GU-LPS-V2-Ex1-TEST")#Bilateral_gu_LpsMasks
    ...
    trainer = Trainer(max_epochs=epoch,fast_dev_run=False,gpus=[4],logger=wandb_logger,auto_lr_find=True, profiler="simple") # max_epochs=epoch ,profiler="advanced", runs one batch to test that the model works
